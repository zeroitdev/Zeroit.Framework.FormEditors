...
namespace Zeroit.Framework.FormEditors.Editors.Brushes
{
    /// <summary>
    ...
    public class BrushPainter
    {
        ...
        public Brush GetBrush(RectangleF rect, GraphicsPath shape)
        {
            if (FillType == BrushPainterType.Solid)
            {
                return new SolidBrush(SolidColor);
            ...
            else if (FillType == BrushPainterType.PathGradient)
            {
                ...
                shape.CloseFigure();
                PathGradientBrush brush = new PathGradientBrush(shape);
                shape.Dispose();
                brush.InterpolationColors = GradientColors;
        ...
        internal Brush GetUITypeEditorBrush(Rectangle bounds, GraphicsPath path)
        {
            return GetBrush(bounds, path);
        }
        ...
        ///     </para>
        /// </remarks>
        public Brush GetBrush(Rectangle rect, GraphicsPath path)
        {
            return GetBrush(new RectangleF(rect.X, rect.Y, rect.Width, rect.Height), path);
        }
        ...
        internal class Converter : TypeConverter
        {
                                             ...
                                             Type destinationType)
			{
					...
					else if (destinationType == typeof(InstanceDescriptor) && value is BrushPainter)
					{
