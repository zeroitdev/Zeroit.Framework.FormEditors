...
namespace Zeroit.Framework.FormEditors.Editors.ColorGradientEditor
{
    ...
    public partial class ColorGradientEditorDialog : System.Windows.Forms.Form
    {
        ...
        {
            exit_Btn.BackColor = Color.FromArgb(22, 22, 22);
        }
        ...
        {
            return colorGradientEditor.Color;
        }

        public Color GetGradientBackColor()
        {
            return colorGradientEditor.GradientBackColor;
        }

        public Color GetGradientBorderColor()
        {
            return colorGradientEditor.GradientBorderColor;
        }

        public Color GetGradientHatchColor()
        {
            return colorGradientEditor.GradientHatchColor;
        }

        public Color SelMarkerFillColor()
        {
            return colorGradientEditor.SelMarkerFillColor;
        }

        public Color SelMarkerBorderColor()
        {
            return colorGradientEditor.MarkerBorderColor;
        }
