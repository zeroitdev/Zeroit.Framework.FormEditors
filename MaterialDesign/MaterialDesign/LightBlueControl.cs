...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.MaterialDesign
{
    public partial class LightBlueControl : System.Windows.Forms.Form
    {
        ...
        private void LightBlue_500_Header_MouseLeave(object sender, EventArgs e)
        {
            ...
            LightBlue_500_Header.BackColor = Colors.LightBlue.lightBlue_header_500;
            zeroitLabel20.BackColor = Colors.LightBlue.lightBlue_header_500;
            zeroitLabel21.BackColor = Colors.LightBlue.lightBlue_header_500;
            swatchNameLabel.BackColor = Colors.LightBlue.lightBlue_header_500;
        }

        private void LightBlue_500_Header_Click_1(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_header_500;
            control.BackColor = Colors.LightBlue.lightBlue_header_500;
        ...
        {
            LightBlue_50.BackColor = Colors.LightBlue.lightBlue_50;
            zeroitLabel18.BackColor = Colors.LightBlue.lightBlue_50;
            zeroitLabel19.BackColor = Colors.LightBlue.lightBlue_50;
        }
        ...
        {
            LightBlue_100.BackColor = Colors.LightBlue.lightBlue_100;
            zeroitLabel16.BackColor = Colors.LightBlue.lightBlue_100;
            zeroitLabel17.BackColor = Colors.LightBlue.lightBlue_100;
        }
        ...
        {
            LightBlue_200.BackColor = Colors.LightBlue.lightBlue_200;
            zeroitLabel14.BackColor = Colors.LightBlue.lightBlue_200;
            zeroitLabel15.BackColor = Colors.LightBlue.lightBlue_200;
        }
        ...
        {
            LightBlue_300.BackColor = Colors.LightBlue.lightBlue_300;
            zeroitLabel13.BackColor = Colors.LightBlue.lightBlue_300;
            zeroitLabel2.BackColor = Colors.LightBlue.lightBlue_300;
        }
        ...
        {
            LightBlue_400.BackColor = Colors.LightBlue.lightBlue_400;
            zeroitLabel23.BackColor = Colors.LightBlue.lightBlue_400;
            zeroitLabel24.BackColor = Colors.LightBlue.lightBlue_400;
        }
        ...
        {
            LightBlue_500.BackColor = Colors.LightBlue.lightBlue_500;
            zeroitLabel25.BackColor = Colors.LightBlue.lightBlue_500;
            zeroitLabel26.BackColor = Colors.LightBlue.lightBlue_500;
        }
        ...
        {
            LightBlue_600.BackColor = Colors.LightBlue.lightBlue_600;
            zeroitLabel27.BackColor = Colors.LightBlue.lightBlue_600;
            zeroitLabel28.BackColor = Colors.LightBlue.lightBlue_600;
        }
        ...
        {
            LightBlue_700.BackColor = Colors.LightBlue.lightBlue_700;
            zeroitLabel29.BackColor = Colors.LightBlue.lightBlue_700;
            zeroitLabel30.BackColor = Colors.LightBlue.lightBlue_700;
        }
        ...
        {
            LightBlue_800.BackColor = Colors.LightBlue.lightBlue_800;
            zeroitLabel31.BackColor = Colors.LightBlue.lightBlue_800;
            zeroitLabel32.BackColor = Colors.LightBlue.lightBlue_800;
        }
        ...
        {
            LightBlue_900.BackColor = Colors.LightBlue.lightBlue_900;
            zeroitLabel33.BackColor = Colors.LightBlue.lightBlue_900;
            zeroitLabel34.BackColor = Colors.LightBlue.lightBlue_900;
        }
        ...
        {
            LightBlue_A100.BackColor = Colors.LightBlue.lightBlue_A100;
            zeroitLabel35.BackColor = Colors.LightBlue.lightBlue_A100;
            zeroitLabel36.BackColor = Colors.LightBlue.lightBlue_A100;
        }
        ...
        {
            LightBlue_A200.BackColor = Colors.LightBlue.lightBlue_A200;
            zeroitLabel37.BackColor = Colors.LightBlue.lightBlue_A200;
            zeroitLabel38.BackColor = Colors.LightBlue.lightBlue_A200;
        }
        ...
        {
            LightBlue_A400.BackColor = Colors.LightBlue.lightBlue_A400;
            zeroitLabel39.BackColor = Colors.LightBlue.lightBlue_A400;
            zeroitLabel40.BackColor = Colors.LightBlue.lightBlue_A400;
        }
        ...
        {
            LightBlue_A700.BackColor = Colors.LightBlue.lightBlue_A700;
            zeroitLabel41.BackColor = Colors.LightBlue.lightBlue_A700;
            zeroitLabel42.BackColor = Colors.LightBlue.lightBlue_A700;
        }
        ...
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_50;
            control.BackColor = Colors.LightBlue.lightBlue_50;
        }


        private void LightBlue_100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_100;
            control.BackColor = Colors.LightBlue.lightBlue_100;
        }

        private void LightBlue_200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_200;
            control.BackColor = Colors.LightBlue.lightBlue_200;
        }

        private void LightBlue_300_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_300;
            control.BackColor = Colors.LightBlue.lightBlue_300;
        }

        private void LightBlue_400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_400;
            control.BackColor = Colors.LightBlue.lightBlue_400;
        }

        private void LightBlue_500_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_500;
            control.BackColor = Colors.LightBlue.lightBlue_500;
        }


        private void LightBlue_600_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_600;
            control.BackColor = Colors.LightBlue.lightBlue_600;
        }

        private void LightBlue_700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_700;
            control.BackColor = Colors.LightBlue.lightBlue_700;
        }

        private void LightBlue_800_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_800;
            control.BackColor = Colors.LightBlue.lightBlue_800;
        }

        private void LightBlue_900_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_900;
            control.BackColor = Colors.LightBlue.lightBlue_900;
        }

        private void LightBlue_A100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_A100;
            control.BackColor = Colors.LightBlue.lightBlue_A100;
        }

        private void LightBlue_A200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_A200;
            control.BackColor = Colors.LightBlue.lightBlue_A200;
        }

        private void LightBlue_A400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_A400;
            control.BackColor = Colors.LightBlue.lightBlue_A400;
        }

        private void LightBlue_A700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.LightBlue.lightBlue_A700;
            control.BackColor = Colors.LightBlue.lightBlue_A700;
        }
