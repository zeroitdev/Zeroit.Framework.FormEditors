...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.MaterialDesign
{
    public partial class OrangeControl : System.Windows.Forms.Form
    {
        ...
        private void Orange_500_Header_MouseLeave(object sender, EventArgs e)
        {
            ...
            Orange_500_Header.BackColor = Colors.Orange.orange_header_500;
            zeroitLabel20.BackColor = Colors.Orange.orange_header_500;
            zeroitLabel21.BackColor = Colors.Orange.orange_header_500;
            swatchNameLabel.BackColor = Colors.Orange.orange_header_500;
        }

        private void Orange_500_Header_Click_1(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_header_500;
            control.BackColor = Colors.Orange.orange_header_500;
        ...
        {
            Orange_50.BackColor = Colors.Orange.orange_50;
            zeroitLabel18.BackColor = Colors.Orange.orange_50;
            zeroitLabel19.BackColor = Colors.Orange.orange_50;
        }
        ...
        {
            Orange_100.BackColor = Colors.Orange.orange_100;
            zeroitLabel16.BackColor = Colors.Orange.orange_100;
            zeroitLabel17.BackColor = Colors.Orange.orange_100;
        }
        ...
        {
            Orange_200.BackColor = Colors.Orange.orange_200;
            zeroitLabel14.BackColor = Colors.Orange.orange_200;
            zeroitLabel15.BackColor = Colors.Orange.orange_200;
        }
        ...
        {
            Orange_300.BackColor = Colors.Orange.orange_300;
            zeroitLabel13.BackColor = Colors.Orange.orange_300;
            zeroitLabel2.BackColor = Colors.Orange.orange_300;
        }
        ...
        {
            Orange_400.BackColor = Colors.Orange.orange_400;
            zeroitLabel23.BackColor = Colors.Orange.orange_400;
            zeroitLabel24.BackColor = Colors.Orange.orange_400;
        }
        ...
        {
            Orange_500.BackColor = Colors.Orange.orange_500;
            zeroitLabel25.BackColor = Colors.Orange.orange_500;
            zeroitLabel26.BackColor = Colors.Orange.orange_500;
        }
        ...
        {
            Orange_600.BackColor = Colors.Orange.orange_600;
            zeroitLabel27.BackColor = Colors.Orange.orange_600;
            zeroitLabel28.BackColor = Colors.Orange.orange_600;
        }
        ...
        {
            Orange_700.BackColor = Colors.Orange.orange_700;
            zeroitLabel29.BackColor = Colors.Orange.orange_700;
            zeroitLabel30.BackColor = Colors.Orange.orange_700;
        }
        ...
        {
            Orange_800.BackColor = Colors.Orange.orange_800;
            zeroitLabel31.BackColor = Colors.Orange.orange_800;
            zeroitLabel32.BackColor = Colors.Orange.orange_800;
        }
        ...
        {
            Orange_900.BackColor = Colors.Orange.orange_900;
            zeroitLabel33.BackColor = Colors.Orange.orange_900;
            zeroitLabel34.BackColor = Colors.Orange.orange_900;
        }
        ...
        {
            Orange_A100.BackColor = Colors.Orange.orange_A100;
            zeroitLabel35.BackColor = Colors.Orange.orange_A100;
            zeroitLabel36.BackColor = Colors.Orange.orange_A100;
        }
        ...
        {
            Orange_A200.BackColor = Colors.Orange.orange_A200;
            zeroitLabel37.BackColor = Colors.Orange.orange_A200;
            zeroitLabel38.BackColor = Colors.Orange.orange_A200;
        }
        ...
        {
            Orange_A400.BackColor = Colors.Orange.orange_A400;
            zeroitLabel39.BackColor = Colors.Orange.orange_A400;
            zeroitLabel40.BackColor = Colors.Orange.orange_A400;
        }
        ...
        {
            Orange_A700.BackColor = Colors.Orange.orange_A700;
            zeroitLabel41.BackColor = Colors.Orange.orange_A700;
            zeroitLabel42.BackColor = Colors.Orange.orange_A700;
        }
        ...
        {
            selectedColor.BackColor = Colors.Orange.orange_50;
            control.BackColor = Colors.Orange.orange_50;
        }


        private void Orange_100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_100;
            control.BackColor = Colors.Orange.orange_100;
        }

        private void Orange_200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_200;
            control.BackColor = Colors.Orange.orange_200;
        }

        private void Orange_300_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_300;
            control.BackColor = Colors.Orange.orange_300;
        }

        private void Orange_400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_400;
            control.BackColor = Colors.Orange.orange_400;
        }

        private void Orange_500_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_500;
            control.BackColor = Colors.Orange.orange_500;
        }


        private void Orange_600_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_600;
            control.BackColor = Colors.Orange.orange_600;
        }

        private void Orange_700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_700;
            control.BackColor = Colors.Orange.orange_700;
        }

        private void Orange_800_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_800;
            control.BackColor = Colors.Orange.orange_800;
        }

        private void Orange_900_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_900;
            control.BackColor = Colors.Orange.orange_900;
        }

        private void Orange_A100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_A100;
            control.BackColor = Colors.Orange.orange_A100;
        }

        private void Orange_A200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_A200;
            control.BackColor = Colors.Orange.orange_A200;
        }

        private void Orange_A400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_A400;
            control.BackColor = Colors.Orange.orange_A400;
        }

        private void Orange_A700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Orange.orange_A700;
            control.BackColor = Colors.Orange.orange_A700;
        }
