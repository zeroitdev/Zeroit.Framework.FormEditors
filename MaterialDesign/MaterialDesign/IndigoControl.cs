...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.MaterialDesign
{
    public partial class IndigoControl : System.Windows.Forms.Form
    {
        ...
        private void Indigo_500_Header_MouseLeave(object sender, EventArgs e)
        {
            ...
            Indigo_500_Header.BackColor = Colors.Indigo.indigo_header_500;
            zeroitLabel20.BackColor = Colors.Indigo.indigo_header_500;
            zeroitLabel21.BackColor = Colors.Indigo.indigo_header_500;
            swatchNameLabel.BackColor = Colors.Indigo.indigo_header_500;
        }

        private void Indigo_500_Header_Click_1(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_header_500;
            control.BackColor = Colors.Indigo.indigo_header_500;
        ...
        {
            Indigo_50.BackColor = Colors.Indigo.indigo_50;
            zeroitLabel18.BackColor = Colors.Indigo.indigo_50;
            zeroitLabel19.BackColor = Colors.Indigo.indigo_50;
        }
        ...
        {
            Indigo_100.BackColor = Colors.Indigo.indigo_100;
            zeroitLabel16.BackColor = Colors.Indigo.indigo_100;
            zeroitLabel17.BackColor = Colors.Indigo.indigo_100;
        }
        ...
        {
            Indigo_200.BackColor = Colors.Indigo.indigo_200;
            zeroitLabel14.BackColor = Colors.Indigo.indigo_200;
            zeroitLabel15.BackColor = Colors.Indigo.indigo_200;
        }
        ...
        {
            Indigo_300.BackColor = Colors.Indigo.indigo_300;
            zeroitLabel13.BackColor = Colors.Indigo.indigo_300;
            zeroitLabel2.BackColor = Colors.Indigo.indigo_300;
        }
        ...
        {
            Indigo_400.BackColor = Colors.Indigo.indigo_400;
            zeroitLabel23.BackColor = Colors.Indigo.indigo_400;
            zeroitLabel24.BackColor = Colors.Indigo.indigo_400;
        }
        ...
        {
            Indigo_500.BackColor = Colors.Indigo.indigo_500;
            zeroitLabel25.BackColor = Colors.Indigo.indigo_500;
            zeroitLabel26.BackColor = Colors.Indigo.indigo_500;
        }
        ...
        {
            Indigo_600.BackColor = Colors.Indigo.indigo_600;
            zeroitLabel27.BackColor = Colors.Indigo.indigo_600;
            zeroitLabel28.BackColor = Colors.Indigo.indigo_600;
        }
        ...
        {
            Indigo_700.BackColor = Colors.Indigo.indigo_700;
            zeroitLabel29.BackColor = Colors.Indigo.indigo_700;
            zeroitLabel30.BackColor = Colors.Indigo.indigo_700;
        }
        ...
        {
            Indigo_800.BackColor = Colors.Indigo.indigo_800;
            zeroitLabel31.BackColor = Colors.Indigo.indigo_800;
            zeroitLabel32.BackColor = Colors.Indigo.indigo_800;
        }
        ...
        {
            Indigo_900.BackColor = Colors.Indigo.indigo_900;
            zeroitLabel33.BackColor = Colors.Indigo.indigo_900;
            zeroitLabel34.BackColor = Colors.Indigo.indigo_900;
        }
        ...
        {
            Indigo_A100.BackColor = Colors.Indigo.indigo_A100;
            zeroitLabel35.BackColor = Colors.Indigo.indigo_A100;
            zeroitLabel36.BackColor = Colors.Indigo.indigo_A100;
        }
        ...
        {
            Indigo_A200.BackColor = Colors.Indigo.indigo_A200;
            zeroitLabel37.BackColor = Colors.Indigo.indigo_A200;
            zeroitLabel38.BackColor = Colors.Indigo.indigo_A200;
        }
        ...
        {
            Indigo_A400.BackColor = Colors.Indigo.indigo_A400;
            zeroitLabel39.BackColor = Colors.Indigo.indigo_A400;
            zeroitLabel40.BackColor = Colors.Indigo.indigo_A400;
        }
        ...
        {
            Indigo_A700.BackColor = Colors.Indigo.indigo_A700;
            zeroitLabel41.BackColor = Colors.Indigo.indigo_A700;
            zeroitLabel42.BackColor = Colors.Indigo.indigo_A700;
        }
        ...
        {
            selectedColor.BackColor = Colors.Indigo.indigo_50;
            control.BackColor = Colors.Indigo.indigo_50;
        }


        private void Indigo_100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_100;
            control.BackColor = Colors.Indigo.indigo_100;
        }

        private void Indigo_200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_200;
            control.BackColor = Colors.Indigo.indigo_200;
        }

        private void Indigo_300_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_300;
            control.BackColor = Colors.Indigo.indigo_300;
        }

        private void Indigo_400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_400;
            control.BackColor = Colors.Indigo.indigo_400;
        }

        private void Indigo_500_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_500;
            control.BackColor = Colors.Indigo.indigo_500;
        }


        private void Indigo_600_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_600;
            control.BackColor = Colors.Indigo.indigo_600;
        }

        private void Indigo_700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_700;
            control.BackColor = Colors.Indigo.indigo_700;
        }

        private void Indigo_800_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_800;
            control.BackColor = Colors.Indigo.indigo_800;
        }

        private void Indigo_900_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_900;
            control.BackColor = Colors.Indigo.indigo_900;
        }

        private void Indigo_A100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_A100;
            control.BackColor = Colors.Indigo.indigo_A100;
        }

        private void Indigo_A200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_A200;
            control.BackColor = Colors.Indigo.indigo_A200;
        }

        private void Indigo_A400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_A400;
            control.BackColor = Colors.Indigo.indigo_A400;
        }

        private void Indigo_A700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Indigo.indigo_A700;
            control.BackColor = Colors.Indigo.indigo_A700;
        }
