...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.MaterialDesign
{
    public partial class BlueControl : System.Windows.Forms.Form
    {
        ...
        private void Blue_500_Header_MouseLeave(object sender, EventArgs e)
        {
            ...
            Blue_500_Header.BackColor = Colors.Blue.blue_header_500;
            zeroitLabel20.BackColor = Colors.Blue.blue_header_500;
            zeroitLabel21.BackColor = Colors.Blue.blue_header_500;
            swatchNameLabel.BackColor = Colors.Blue.blue_header_500;
        }

        private void Blue_500_Header_Click_1(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_header_500;
            control.BackColor = Colors.Blue.blue_header_500;
        ...
        {
            Blue_50.BackColor = Colors.Blue.blue_50;
            zeroitLabel18.BackColor = Colors.Blue.blue_50;
            zeroitLabel19.BackColor = Colors.Blue.blue_50;
        }
        ...
        {
            Blue_100.BackColor = Colors.Blue.blue_100;
            zeroitLabel16.BackColor = Colors.Blue.blue_100;
            zeroitLabel17.BackColor = Colors.Blue.blue_100;
        }
        ...
        {
            Blue_200.BackColor = Colors.Blue.blue_200;
            zeroitLabel14.BackColor = Colors.Blue.blue_200;
            zeroitLabel15.BackColor = Colors.Blue.blue_200;
        }
        ...
        {
            Blue_300.BackColor = Colors.Blue.blue_300;
            zeroitLabel13.BackColor = Colors.Blue.blue_300;
            zeroitLabel2.BackColor = Colors.Blue.blue_300;
        }
        ...
        {
            Blue_400.BackColor = Colors.Blue.blue_400;
            zeroitLabel23.BackColor = Colors.Blue.blue_400;
            zeroitLabel24.BackColor = Colors.Blue.blue_400;
        }
        ...
        {
            Blue_500.BackColor = Colors.Blue.blue_500;
            zeroitLabel25.BackColor = Colors.Blue.blue_500;
            zeroitLabel26.BackColor = Colors.Blue.blue_500;
        }
        ...
        {
            Blue_600.BackColor = Colors.Blue.blue_600;
            zeroitLabel27.BackColor = Colors.Blue.blue_600;
            zeroitLabel28.BackColor = Colors.Blue.blue_600;
        }
        ...
        {
            Blue_700.BackColor = Colors.Blue.blue_700;
            zeroitLabel29.BackColor = Colors.Blue.blue_700;
            zeroitLabel30.BackColor = Colors.Blue.blue_700;
        }
        ...
        {
            Blue_800.BackColor = Colors.Blue.blue_800;
            zeroitLabel31.BackColor = Colors.Blue.blue_800;
            zeroitLabel32.BackColor = Colors.Blue.blue_800;
        }
        ...
        {
            Blue_900.BackColor = Colors.Blue.blue_900;
            zeroitLabel33.BackColor = Colors.Blue.blue_900;
            zeroitLabel34.BackColor = Colors.Blue.blue_900;
        }
        ...
        {
            Blue_A100.BackColor = Colors.Blue.blue_A100;
            zeroitLabel35.BackColor = Colors.Blue.blue_A100;
            zeroitLabel36.BackColor = Colors.Blue.blue_A100;
        }
        ...
        {
            Blue_A200.BackColor = Colors.Blue.blue_A200;
            zeroitLabel37.BackColor = Colors.Blue.blue_A200;
            zeroitLabel38.BackColor = Colors.Blue.blue_A200;
        }
        ...
        {
            Blue_A400.BackColor = Colors.Blue.blue_A400;
            zeroitLabel39.BackColor = Colors.Blue.blue_A400;
            zeroitLabel40.BackColor = Colors.Blue.blue_A400;
        }
        ...
        {
            Blue_A700.BackColor = Colors.Blue.blue_A700;
            zeroitLabel41.BackColor = Colors.Blue.blue_A700;
            zeroitLabel42.BackColor = Colors.Blue.blue_A700;
        }
        ...
        {
            selectedColor.BackColor = Colors.Blue.blue_50;
            control.BackColor = Colors.Blue.blue_50;
        }


        private void Blue_100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_100;
            control.BackColor = Colors.Blue.blue_100;
        }

        private void Blue_200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_200;
            control.BackColor = Colors.Blue.blue_200;
        }

        private void Blue_300_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_300;
            control.BackColor = Colors.Blue.blue_300;
        }

        private void Blue_400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_400;
            control.BackColor = Colors.Blue.blue_400;
        }

        private void Blue_500_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_500;
            control.BackColor = Colors.Blue.blue_500;
        }


        private void Blue_600_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_600;
            control.BackColor = Colors.Blue.blue_600;
        }

        private void Blue_700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_700;
            control.BackColor = Colors.Blue.blue_700;
        }

        private void Blue_800_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_800;
            control.BackColor = Colors.Blue.blue_800;
        }

        private void Blue_900_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_900;
            control.BackColor = Colors.Blue.blue_900;
        }

        private void Blue_A100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_A100;
            control.BackColor = Colors.Blue.blue_A100;
        }

        private void Blue_A200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_A200;
            control.BackColor = Colors.Blue.blue_A200;
        }

        private void Blue_A400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_A400;
            control.BackColor = Colors.Blue.blue_A400;
        }

        private void Blue_A700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Blue.blue_A700;
            control.BackColor = Colors.Blue.blue_A700;
        }
