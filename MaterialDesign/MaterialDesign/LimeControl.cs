...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.MaterialDesign
{
    public partial class LimeControl : System.Windows.Forms.Form
    {
        ...
        private void Lime_500_Header_MouseLeave(object sender, EventArgs e)
        {
            ...
            Lime_500_Header.BackColor = Colors.Lime.lime_header_500;
            zeroitLabel20.BackColor = Colors.Lime.lime_header_500;
            zeroitLabel21.BackColor = Colors.Lime.lime_header_500;
            swatchNameLabel.BackColor = Colors.Lime.lime_header_500;
        }

        private void Lime_500_Header_Click_1(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_header_500;
            control.BackColor = Colors.Lime.lime_header_500;
        ...
        {
            Lime_50.BackColor = Colors.Lime.lime_50;
            zeroitLabel18.BackColor = Colors.Lime.lime_50;
            zeroitLabel19.BackColor = Colors.Lime.lime_50;
        }
        ...
        {
            Lime_100.BackColor = Colors.Lime.lime_100;
            zeroitLabel16.BackColor = Colors.Lime.lime_100;
            zeroitLabel17.BackColor = Colors.Lime.lime_100;
        }
        ...
        {
            Lime_200.BackColor = Colors.Lime.lime_200;
            zeroitLabel14.BackColor = Colors.Lime.lime_200;
            zeroitLabel15.BackColor = Colors.Lime.lime_200;
        }
        ...
        {
            Lime_300.BackColor = Colors.Lime.lime_300;
            zeroitLabel13.BackColor = Colors.Lime.lime_300;
            zeroitLabel2.BackColor = Colors.Lime.lime_300;
        }
        ...
        {
            Lime_400.BackColor = Colors.Lime.lime_400;
            zeroitLabel23.BackColor = Colors.Lime.lime_400;
            zeroitLabel24.BackColor = Colors.Lime.lime_400;
        }
        ...
        {
            Lime_500.BackColor = Colors.Lime.lime_500;
            zeroitLabel25.BackColor = Colors.Lime.lime_500;
            zeroitLabel26.BackColor = Colors.Lime.lime_500;
        }
        ...
        {
            Lime_600.BackColor = Colors.Lime.lime_600;
            zeroitLabel27.BackColor = Colors.Lime.lime_600;
            zeroitLabel28.BackColor = Colors.Lime.lime_600;
        }
        ...
        {
            Lime_700.BackColor = Colors.Lime.lime_700;
            zeroitLabel29.BackColor = Colors.Lime.lime_700;
            zeroitLabel30.BackColor = Colors.Lime.lime_700;
        }
        ...
        {
            Lime_800.BackColor = Colors.Lime.lime_800;
            zeroitLabel31.BackColor = Colors.Lime.lime_800;
            zeroitLabel32.BackColor = Colors.Lime.lime_800;
        }
        ...
        {
            Lime_900.BackColor = Colors.Lime.lime_900;
            zeroitLabel33.BackColor = Colors.Lime.lime_900;
            zeroitLabel34.BackColor = Colors.Lime.lime_900;
        }
        ...
        {
            Lime_A100.BackColor = Colors.Lime.lime_A100;
            zeroitLabel35.BackColor = Colors.Lime.lime_A100;
            zeroitLabel36.BackColor = Colors.Lime.lime_A100;
        }
        ...
        {
            Lime_A200.BackColor = Colors.Lime.lime_A200;
            zeroitLabel37.BackColor = Colors.Lime.lime_A200;
            zeroitLabel38.BackColor = Colors.Lime.lime_A200;
        }
        ...
        {
            Lime_A400.BackColor = Colors.Lime.lime_A400;
            zeroitLabel39.BackColor = Colors.Lime.lime_A400;
            zeroitLabel40.BackColor = Colors.Lime.lime_A400;
        }
        ...
        {
            Lime_A700.BackColor = Colors.Lime.lime_A700;
            zeroitLabel41.BackColor = Colors.Lime.lime_A700;
            zeroitLabel42.BackColor = Colors.Lime.lime_A700;
        }
        ...
        {
            selectedColor.BackColor = Colors.Lime.lime_50;
            control.BackColor = Colors.Lime.lime_50;
        }


        private void Lime_100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_100;
            control.BackColor = Colors.Lime.lime_100;
        }

        private void Lime_200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_200;
            control.BackColor = Colors.Lime.lime_200;
        }

        private void Lime_300_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_300;
            control.BackColor = Colors.Lime.lime_300;
        }

        private void Lime_400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_400;
            control.BackColor = Colors.Lime.lime_400;
        }

        private void Lime_500_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_500;
            control.BackColor = Colors.Lime.lime_500;
        }


        private void Lime_600_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_600;
            control.BackColor = Colors.Lime.lime_600;
        }

        private void Lime_700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_700;
            control.BackColor = Colors.Lime.lime_700;
        }

        private void Lime_800_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_800;
            control.BackColor = Colors.Lime.lime_800;
        }

        private void Lime_900_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_900;
            control.BackColor = Colors.Lime.lime_900;
        }

        private void Lime_A100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_A100;
            control.BackColor = Colors.Lime.lime_A100;
        }

        private void Lime_A200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_A200;
            control.BackColor = Colors.Lime.lime_A200;
        }

        private void Lime_A400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_A400;
            control.BackColor = Colors.Lime.lime_A400;
        }

        private void Lime_A700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Lime.lime_A700;
            control.BackColor = Colors.Lime.lime_A700;
        }
