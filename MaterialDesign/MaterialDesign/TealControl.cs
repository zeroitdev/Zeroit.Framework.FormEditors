...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.MaterialDesign
{
    public partial class TealControl : System.Windows.Forms.Form
    {
        ...
        private void Teal_500_Header_MouseLeave(object sender, EventArgs e)
        {
            ...
            Teal_500_Header.BackColor = Colors.Teal.teal_header_500;
            zeroitLabel20.BackColor = Colors.Teal.teal_header_500;
            zeroitLabel21.BackColor = Colors.Teal.teal_header_500;
            swatchNameLabel.BackColor = Colors.Teal.teal_header_500;
        }

        private void Teal_500_Header_Click_1(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_header_500;
            control.BackColor = Colors.Teal.teal_header_500;
        ...
        {
            Teal_50.BackColor = Colors.Teal.teal_50;
            zeroitLabel18.BackColor = Colors.Teal.teal_50;
            zeroitLabel19.BackColor = Colors.Teal.teal_50;
        }
        ...
        {
            Teal_100.BackColor = Colors.Teal.teal_100;
            zeroitLabel16.BackColor = Colors.Teal.teal_100;
            zeroitLabel17.BackColor = Colors.Teal.teal_100;
        }
        ...
        {
            Teal_200.BackColor = Colors.Teal.teal_200;
            zeroitLabel14.BackColor = Colors.Teal.teal_200;
            zeroitLabel15.BackColor = Colors.Teal.teal_200;
        }
        ...
        {
            Teal_300.BackColor = Colors.Teal.teal_300;
            zeroitLabel13.BackColor = Colors.Teal.teal_300;
            zeroitLabel2.BackColor = Colors.Teal.teal_300;
        }
        ...
        {
            Teal_400.BackColor = Colors.Teal.teal_400;
            zeroitLabel23.BackColor = Colors.Teal.teal_400;
            zeroitLabel24.BackColor = Colors.Teal.teal_400;
        }
        ...
        {
            Teal_500.BackColor = Colors.Teal.teal_500;
            zeroitLabel25.BackColor = Colors.Teal.teal_500;
            zeroitLabel26.BackColor = Colors.Teal.teal_500;
        }
        ...
        {
            Teal_600.BackColor = Colors.Teal.teal_600;
            zeroitLabel27.BackColor = Colors.Teal.teal_600;
            zeroitLabel28.BackColor = Colors.Teal.teal_600;
        }
        ...
        {
            Teal_700.BackColor = Colors.Teal.teal_700;
            zeroitLabel29.BackColor = Colors.Teal.teal_700;
            zeroitLabel30.BackColor = Colors.Teal.teal_700;
        }
        ...
        {
            Teal_800.BackColor = Colors.Teal.teal_800;
            zeroitLabel31.BackColor = Colors.Teal.teal_800;
            zeroitLabel32.BackColor = Colors.Teal.teal_800;
        }
        ...
        {
            Teal_900.BackColor = Colors.Teal.teal_900;
            zeroitLabel33.BackColor = Colors.Teal.teal_900;
            zeroitLabel34.BackColor = Colors.Teal.teal_900;
        }
        ...
        {
            Teal_A100.BackColor = Colors.Teal.teal_A100;
            zeroitLabel35.BackColor = Colors.Teal.teal_A100;
            zeroitLabel36.BackColor = Colors.Teal.teal_A100;
        }
        ...
        {
            Teal_A200.BackColor = Colors.Teal.teal_A200;
            zeroitLabel37.BackColor = Colors.Teal.teal_A200;
            zeroitLabel38.BackColor = Colors.Teal.teal_A200;
        }
        ...
        {
            Teal_A400.BackColor = Colors.Teal.teal_A400;
            zeroitLabel39.BackColor = Colors.Teal.teal_A400;
            zeroitLabel40.BackColor = Colors.Teal.teal_A400;
        }
        ...
        {
            Teal_A700.BackColor = Colors.Teal.teal_A700;
            zeroitLabel41.BackColor = Colors.Teal.teal_A700;
            zeroitLabel42.BackColor = Colors.Teal.teal_A700;
        }
        ...
        {
            selectedColor.BackColor = Colors.Teal.teal_50;
            control.BackColor = Colors.Teal.teal_50;
        }


        private void Teal_100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_100;
            control.BackColor = Colors.Teal.teal_100;
        }

        private void Teal_200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_200;
            control.BackColor = Colors.Teal.teal_200;
        }

        private void Teal_300_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_300;
            control.BackColor = Colors.Teal.teal_300;
        }

        private void Teal_400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_400;
            control.BackColor = Colors.Teal.teal_400;
        }

        private void Teal_500_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_500;
            control.BackColor = Colors.Teal.teal_500;
        }


        private void Teal_600_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_600;
            control.BackColor = Colors.Teal.teal_600;
        }

        private void Teal_700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_700;
            control.BackColor = Colors.Teal.teal_700;
        }

        private void Teal_800_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_800;
            control.BackColor = Colors.Teal.teal_800;
        }

        private void Teal_900_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_900;
            control.BackColor = Colors.Teal.teal_900;
        }

        private void Teal_A100_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_A100;
            control.BackColor = Colors.Teal.teal_A100;
        }

        private void Teal_A200_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_A200;
            control.BackColor = Colors.Teal.teal_A200;
        }

        private void Teal_A400_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_A400;
            control.BackColor = Colors.Teal.teal_A400;
        }

        private void Teal_A700_Click(object sender, EventArgs e)
        {
            selectedColor.BackColor = Colors.Teal.teal_A700;
            control.BackColor = Colors.Teal.teal_A700;
        }
