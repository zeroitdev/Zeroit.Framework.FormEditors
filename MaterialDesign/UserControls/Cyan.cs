...
namespace Zeroit.Framework.FormEditors.MaterialDesignColors.UserControls
{
    ...
    public partial class Cyan : UserControl
    {
        ...
        private Color getColor = Colors.Cyan.cyan_header_500;
        ...
        {
            getColor = Colors.Cyan.cyan_header_500;
