...
namespace Zeroit.Framework.FormEditors
{
    ...
    public partial class ColorGradientEditor : UserControl
    {
        ...
        {
            Zeroit.Framework.FormEditors.Editors.ComboColorPicker.ComboColorPickerDialog d = new Zeroit.Framework.FormEditors.Editors.ComboColorPicker.ComboColorPickerDialog(colorLabel.BackColor, colorButton);
